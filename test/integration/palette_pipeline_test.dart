...
final _testPaints = <PaintColour>[
  ...
  const PaintColour(
    ...
    paletteFamily: PaletteFamily.coolNeutrals,
    cabStar: 3.81,
    chromaBand: ChromaBand.muted,
  ),
  // Pastels
  const PaintColour(
    ...
    lrv: 61.0,
    undertone: Undertone.warm,
    paletteFamily: PaletteFamily.pastels,
    cabStar: 9.96,
    chromaBand: ChromaBand.muted,
  ),
  // Jewel tones
  const PaintColour(
    ...
    paletteFamily: PaletteFamily.jewelTones,
    cabStar: 14.7,
    chromaBand: ChromaBand.muted,
  ),
  const PaintColour(
  ...
  const PaintColour(
    ...
    lrv: 40.0,
    undertone: Undertone.warm,
    paletteFamily: PaletteFamily.brights,
    cabStar: 78.82,
    chromaBand: ChromaBand.bold,
  ),
];
