...
abstract final class PaletteTheme {
  static ThemeData get light => ThemeData(
    ...
    appBarTheme: AppBarTheme(
      ...
      iconTheme: const IconThemeData(color: PaletteColours.textPrimary),
    ),
    ...
    textButtonTheme: TextButtonThemeData(
      style: TextButton.styleFrom(foregroundColor: PaletteColours.sageGreen),
    ),
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(12),
        borderSide: const BorderSide(color: PaletteColours.sageGreen, width: 2),
      ),
