...
class RoomGuidance {
  const RoomGuidance({required this.insight, required this.avoid});
...
const Map<String, RoomGuidance> roomColourGuidance = {
  'bedroom': RoomGuidance(
    ...
    avoid:
        'Highly saturated brights or energising reds near the bed — '
  ...
  'kitchen': RoomGuidance(
    ...
    avoid:
        'Cool greys or blues can feel clinical in a kitchen — '
  ...
  'living': RoomGuidance(
    ...
    avoid:
        'Very dark walls in a small living room can feel oppressive — '
  ...
  'office': RoomGuidance(
    ...
    avoid:
        'Overly warm or bright colours can be distracting during '
  ...
  'dining': RoomGuidance(
    ...
    avoid:
        'Very cool or sterile colours can make a dining room feel '
  ...
  'bathroom': RoomGuidance(
    ...
    avoid:
        'Very dark colours in a small windowless bathroom can feel '
  ...
  'hallway': RoomGuidance(
    ...
    avoid:
        'Busy patterns or too many accent colours in a narrow '
  ...
  'nursery': RoomGuidance(
    ...
    avoid:
        'Highly stimulating brights or bold contrasts — '
